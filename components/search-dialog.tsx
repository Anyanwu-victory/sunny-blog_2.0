...
export function SearchDialog({ isMobile = false }: SearchDialogProps) {
    ...
    <>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search..."
          className="w-full max-w-sm pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 cursor-pointer"
          readOnly
        />
      </div>
          ...
          <DialogHeader className="p-6 pb-0">
            ...
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                placeholder="Search for people, publications, and topics..."
